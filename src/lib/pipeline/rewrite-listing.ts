...
- condition_notes: polished prose that merges AI photo observations with the condition notes above — no contradictions with the description; maximum 1000 characters; describe ONLY physical condition (wear, damage, cleanliness, structural integrity) — never include pricing, discounts, shipping, returns, payment terms, branding slogans, or promotional language
    ...
    rewrite = await runStructured<RewriteOutput>({
      ...
      jsonSchema: {
        ...
        properties: {
          ...
          condition_notes: {
            type: 'string',
            description: 'Polished condition notes reconciled with the description — no contradictions. Maximum 1000 characters. Describe ONLY physical condition — no pricing, promotions, shipping, returns, payment, or branding.',
            maxLength: 1000,
          },
        },
        required: [
